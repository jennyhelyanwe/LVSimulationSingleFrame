...
gfx modify spectrum default clear overwrite_colour;
gfx modify spectrum default linear reverse range -0.25 0 extend_above extend_below rainbow colour_range 0 1 component 1;

$frame=3;
gfx read node;"output_VisualStep_Opt/Contracted_".${frame}
gfx read elem;"output_VisualStep_Opt/Contracted_".${frame}
gfx modify g_element LVContracted_OptTCa general clear circle_discretization 6 default_coordinate deformed element_discretization "12*12*12" native_discretization none;
gfx modify g_element LVContracted_OptTCa lines select_on material default selected_material default_selected;
gfx modify g_element LVContracted_OptTCa cylinders constant_radius 0.3 select_on material muscle selected_material default_selected render_shaded;
gfx modify g_element LVContracted_OptTCa surfaces face xi3_0 select_on material muscle selected_material default_selected render_shaded;



gfx read data;"output_VisualStep_Opt/Contracted_gauss_ER_".${frame}

gfx def field embedded_coordinates embedded element_xi element_xi field deformed;
gfx modify g_element gauss_strain general clear circle_discretization 6 element_discretization "4*4*4" native_discretization none;
gfx modify g_element gauss_strain lines select_on material default selected_material default_selected;
gfx modify g_element gauss_strain data_points coordinate embedded_coordinates glyph sphere general size "4*4*4" centre 0,0,0 font default select_on material default data yg1 spectrum default selected_material default_selected;
